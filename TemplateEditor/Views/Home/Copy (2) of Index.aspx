...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="ui-page-container ui-page-border ui-page-content">
        <div class="canvas-updateable aloha-editable-active mercury-region" id="coverpage-canvas" data-type="editable">
            <br>
            <br>
            ...
            <div contenteditable="false" class="aloha-table-wrapper">
                ...
                <div>
                    <div class="aloha-table-column-resize-dragger" style="top: 0px; left: 90px;">
                    </div>
                    <div class="aloha-table-column-resize-guide" style="top: 0px; left: 62px; display: none;">
                    </div>
                </div>
            </div>
        </div>
